<%@ Page Title="Home Page" Language="C#" MasterPageFile="Shared/Site.master" AutoEventWireup="true"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Repeater runat="server" ID="photoInfo">
        <ItemTemplate>
            <%--<a href="<%# DataBinder.Eval(Container.DataItem, "categoryName") %>.aspx">--%>
            <a href="Pics.aspx?category=<%# DataBinder.Eval(Container.DataItem, "categoryName") %>">
